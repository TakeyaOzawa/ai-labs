...
目的:
    ...
    AIコマンドプロセスで実行する。100件超のメタデータでもコンテキスト圧迫なく
    処理できるようにする。
...
依存: python3.12, gws CLI, kiro-cli または claude (AI_COMMAND_TYPE環境変数で切替), filter-gws-drive-metadata.py
"""
...
TMP_DIR = HOME / "Documents" / "works" / "scout_reports" / "gws_trends" / "daily" / "tmp"
OUTPUT_BASE = HOME / "Documents" / "works" / "scout_reports" / "gws_trends" / "daily"
