...
使い方:
    python3.12 scripts/fetch-rss-feeds.py --category <tech|biz|academic|tech_events|lifestyle_events> --date <YYYY-MM-DD> [--output <path>] [--no-filter]

例:
    python3.12 scripts/fetch-rss-feeds.py --category tech --date 2026-05-05
    python3.12 scripts/fetch-rss-feeds.py --category biz --date 2026-05-05 --output /tmp/biz.md
...
def main() -> None:
    ...
    parser.add_argument("--category", required=True, choices=["tech", "biz", "academic", "tech_events", "lifestyle_events"],
                        help="取得カテゴリ")
