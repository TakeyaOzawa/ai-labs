...
使い方:
    ...
    python3.12 scripts/notify-slack.py --file <path> --channel C01AB23CD45EF
    python3.12 scripts/notify-slack.py --file <path> --thread compact
    python3.12 scripts/notify-slack.py --file <path> --thread <thread_ts>

例:
    python3.12 scripts/notify-slack.py --file ~/Documents/works/scout_reports/2026-05-14_daily.md
    python3.12 scripts/notify-slack.py --file ~/Documents/works/scout_reports/2026-05-14_daily.md --channel C01AB23CD45EF
...
DEFAULT_CHANNEL = os.environ.get("SLACK_DISPATCH_DM_CHANNEL", "")
    ...
    if not args.channel:
        print(
            json.dumps(
                {
                    "success": False,
                    "error": "環境変数 SLACK_DISPATCH_DM_CHANNEL が未設定です（--channel で直接指定も可）",
                },
                ensure_ascii=False,
            )
        )
