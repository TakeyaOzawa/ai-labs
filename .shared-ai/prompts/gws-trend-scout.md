...
}' 2>/dev/null > Documents/works/scout_histories/gws_trends/daily/tmp/{種別}_metadata.ndjson
```
...
python3.12 ~/scripts/filter-gws-drive-metadata.py \
  --input Documents/works/scout_histories/gws_trends/daily/tmp/{種別}_metadata.ndjson \
  --output Documents/works/scout_histories/gws_trends/daily/tmp/{種別}_filtered.json \
...
invokeSubAgent:
  ...
  prompt: |
    ...
    入力ファイル: Documents/works/scout_histories/gws_trends/daily/tmp/docs.md, Documents/works/scout_histories/gws_trends/daily/tmp/slides.md, Documents/works/scout_histories/gws_trends/daily/tmp/sheets.md, Documents/works/scout_histories/gws_trends/daily/tmp/forms.md, Documents/works/scout_histories/gws_trends/daily/tmp/pdf.md
