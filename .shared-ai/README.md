...
| `agent-prompt-writing-guide.md` | `agent-prompt-guide.md` + `agent-creation-guide.md` | `references/` |
...
|---|---|---|
| `kiro-architecture-rules.md` | .kiro/配下の設計原則チェック | `.kiro/**/*.{md,json,hook}` |
| `reference-guide-format.md` | referenceガイドのフォーマット確認 | `.shared-ai/references/*-guide.md` |
| `domain-frontmatter-check.md` | ドメインファイルのfront-matter確認 | `docs/domain/**/*.md` |
| `spec-frontmatter-check.md` | specファイルのfront-matter確認 | `.kiro/specs/**/*.md` |
| `spec-tasks-completion-check.md` | 全タスク完了時の提案 | `.kiro/specs/**/tasks.md` |
| `test-refresh-db-guard.md` | RefreshDatabase使用禁止 | `tests/**/*Test.php` |
| `poc-to-writer-update.md` | PoC完了→記事化提案 | `works/poc-something/**/SUMMARY.md` |
