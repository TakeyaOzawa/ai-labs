...
出力先: Documents/works/scout_histories/github_repo_analysis/.tmp_{slug}_refs.md
```
...
競合: {competitors}
エコシステム: {ecosystem}
出力先: Documents/works/scout_histories/github_repo_analysis/.tmp_{slug}_web.md
...
出力先: Documents/works/scout_histories/github_repo_analysis/.tmp_{slug}_codebase.md
```
