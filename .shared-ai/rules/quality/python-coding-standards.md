...
使い方:
    python3.12 scripts/{script-name}.py <必須引数> [任意引数]
    python3.12 scripts/{script-name}.py --option value

例:
    python3.12 scripts/rss/fetch-rss-feeds.py --category tech --date 2026-05-05
