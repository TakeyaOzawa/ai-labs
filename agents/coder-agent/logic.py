...
app = FastAPI(title="CoderAgent", version="1.0.0")
...
async def health_check():
    return {"status": "healthy", "agent": "coder", "role": role_manager.role.name}
